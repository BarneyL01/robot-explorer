 ...
 async create() {
  ...
  async loadConfigs() {
    try {
      ...
      this.gridResourcesConfig = {
        gridResources: {
          "0,0": { "weights": { "food": 7, "scrap": 1, "circuits": 1, "fuel": 1 }, "amounts": { "food": 5, "scrap": 3, "circuits": 1, "fuel": 2 } },
          "0,1": { "weights": { "food": 6, "scrap": 2, "circuits": 1, "fuel": 1 }, "amounts": { "food": 4, "scrap": 4, "circuits": 1, "fuel": 2 } },
          "0,2": { "weights": { "food": 5, "scrap": 3, "circuits": 1, "fuel": 1 }, "amounts": { "food": 4, "scrap": 5, "circuits": 1, "fuel": 2 } },
          "0,3": { "weights": { "food": 4, "scrap": 4, "circuits": 1, "fuel": 1 }, "amounts": { "food": 3, "scrap": 6, "circuits": 1, "fuel": 2 } },
          "0,4": { "weights": { "food": 3, "scrap": 5, "circuits": 1, "fuel": 1 }, "amounts": { "food": 3, "scrap": 7, "circuits": 1, "fuel": 2 } },
          "1,0": { "weights": { "food": 6, "scrap": 2, "circuits": 1, "fuel": 1 }, "amounts": { "food": 5, "scrap": 3, "circuits": 1, "fuel": 1 } },
          "1,1": { "weights": { "food": 5, "scrap": 3, "circuits": 1, "fuel": 1 }, "amounts": { "food": 4, "scrap": 4, "circuits": 1, "fuel": 1 } },
          "1,2": { "weights": { "food": 0, "scrap": 8, "circuits": 2, "fuel": 0 }, "amounts": { "food": 2, "scrap": 2, "circuits": 2, "fuel": 2 } },
          "1,3": { "weights": { "food": 3, "scrap": 5, "circuits": 1, "fuel": 1 }, "amounts": { "food": 3, "scrap": 6, "circuits": 1, "fuel": 1 } },
          "1,4": { "weights": { "food": 2, "scrap": 6, "circuits": 1, "fuel": 1 }, "amounts": { "food": 3, "scrap": 7, "circuits": 1, "fuel": 1 } },
          "2,0": { "weights": { "food": 6, "scrap": 1, "circuits": 2, "fuel": 1 }, "amounts": { "food": 5, "scrap": 2, "circuits": 1, "fuel": 3 } },
          "2,1": { "weights": { "food": 8, "scrap": 0, "circuits": 1, "fuel": 1 }, "amounts": { "food": 2, "scrap": 2, "circuits": 2, "fuel": 2 } },
          "2,2": { "weights": { "food": 4, "scrap": 3, "circuits": 2, "fuel": 1 }, "amounts": { "food": 4, "scrap": 4, "circuits": 1, "fuel": 5 } },
          "2,3": { "weights": { "food": 0, "scrap": 1, "circuits": 1, "fuel": 8 }, "amounts": { "food": 2, "scrap": 2, "circuits": 2, "fuel": 2 } },
          "2,4": { "weights": { "food": 2, "scrap": 5, "circuits": 2, "fuel": 1 }, "amounts": { "food": 3, "scrap": 6, "circuits": 1, "fuel": 7 } },
          "3,0": { "weights": { "food": 5, "scrap": 2, "circuits": 2, "fuel": 1 }, "amounts": { "food": 5, "scrap": 2, "circuits": 1, "fuel": 3 } },
          "3,1": { "weights": { "food": 4, "scrap": 3, "circuits": 2, "fuel": 1 }, "amounts": { "food": 4, "scrap": 3, "circuits": 1, "fuel": 4 } },
          "3,2": { "weights": { "food": 1, "scrap": 1, "circuits": 8, "fuel": 0 }, "amounts": { "food": 2, "scrap": 2, "circuits": 2, "fuel": 2 } },
          "3,3": { "weights": { "food": 2, "scrap": 5, "circuits": 2, "fuel": 1 }, "amounts": { "food": 3, "scrap": 5, "circuits": 1, "fuel": 6 } },
          "3,4": { "weights": { "food": 1, "scrap": 6, "circuits": 2, "fuel": 1 }, "amounts": { "food": 3, "scrap": 6, "circuits": 1, "fuel": 7 } },
          "4,0": { "weights": { "food": 5, "scrap": 1, "circuits": 3, "fuel": 1 }, "amounts": { "food": 5, "scrap": 1, "circuits": 1, "fuel": 4 } },
          "4,1": { "weights": { "food": 4, "scrap": 2, "circuits": 3, "fuel": 1 }, "amounts": { "food": 4, "scrap": 2, "circuits": 1, "fuel": 5 } },
          "4,2": { "weights": { "food": 3, "scrap": 3, "circuits": 3, "fuel": 1 }, "amounts": { "food": 4, "scrap": 3, "circuits": 1, "fuel": 6 } },
          "4,3": { "weights": { "food": 2, "scrap": 4, "circuits": 3, "fuel": 1 }, "amounts": { "food": 3, "scrap": 4, "circuits": 1, "fuel": 7 } },
          "4,4": { "weights": { "food": 1, "scrap": 5, "circuits": 3, "fuel": 1 }, "amounts": { "food": 3, "scrap": 5, "circuits": 1, "fuel": 8 } }
        },
        collectionChance: 75
      };
